document.addEventListener('DOMContentLoaded', () => {
    ...
    // ---------------------------------------------------------------
    // PRODUKT-DATENBANK 2026
    // Struktur: category -> brand -> serie -> [varianten]
    // Eine Serie mit nur 1 Variante zeigt gar keine Varianten-Auswahl an.
    // ---------------------------------------------------------------
    const productDB = {
        'Smartphone': {
            'Apple': {
    ...
    // Farben, die für so gut wie jede Kategorie sinnvoll sind
    const colorOptions = ['Schwarz', 'Weiß', 'Silber', 'Grau', 'Blau', 'Rot', 'Grün', 'Gold', 'Rosé/Pink', 'Bunt'];

    // Hüllen/Zubehör-Optionen je Kategorie (nur wo sinnvoll)
    const caseOptionsByCategory = {
